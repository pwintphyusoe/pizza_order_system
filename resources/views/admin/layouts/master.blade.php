            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{ route('user#contactListPage') }}" class="text-decoration-none">
                                <i class="fa-regular fa-address-card"></i>Contact List</a>
                        </li>
                    </ul>
                </nav>
            </div>
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__footer my-3">
                                                <form action="{{ route('logout') }}" method="post">
                                                    @csrf
                                                    <button class="btn btn-dark text-white col-10 offset-1"><i class="zmdi zmdi-power"></i>  Logout</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
