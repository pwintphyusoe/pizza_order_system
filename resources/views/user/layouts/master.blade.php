                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            {{-- <a href="" class="btn px-0">
                                ...
                                <span class="badge text-secondary border border-secondary rounded-circle" style="padding-bottom: 2px;">Contact</span>
                            </a> --}}
                            ...
                            <div class="dropdown d-inline me-5">
                                ...
                                <ul class="dropdown-menu">
                                  <li><a class="dropdown-item" href="{{ route('user#infoPage') }}">Account</a></li>
                                  <li><a class="dropdown-item" href="{{ route('user#changePasswordPage') }}">Change Password</a></li>
                                  <li>
                                    <form action="{{ route('logout')}}" method="post">
                                        @csrf
                                        <div class="text-center bg-dark">
                                            <button class="btn text-white"><i class="fa-solid fa-right-from-bracket"></i>Logout</button>
                                        </div>
                                    </form>
                                  </li>
                                </ul>
