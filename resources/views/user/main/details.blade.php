            ...
            <div class="h-100 bg-light p-30">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    <div class="input-group quantity mr-3" style="width: 130px;">
                        ...
                        <input type="text" class="form-control bg-secondary border-0 text-center" value="1" id="countPizza">
                        <div class="input-group-btn">
                    ...
                    <button type="button" id="orderCountPizza" class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</button>
                </div>
            ...
            @foreach($pizzaList as $p)
                ...
                <div class="product-item bg-light">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="{{ asset('storage/'.$p->image) }}" alt="" style="height:240px">
...
<script>
    $(document).ready(function(){
        ...
        //add to card
        $('#orderCountPizza').click(function(){

            $source = {
                'userId' : $('#userId').val(),
                'pizzaId' : $('#pizzaId').val(),
                'count' : $('#countPizza').val()
            };
            // console.log($source);
